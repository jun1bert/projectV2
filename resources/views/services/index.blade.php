...
<div class="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 flex flex-col justify-between">
    ...
    <div>
        ...
        <div class="mt-1.5 flex items-center gap-2 text-sm">
            <span class="font-semibold text-indigo-600">₱{{ number_format($s->price, 2) }}</span>
    ...
    <div class="flex justify-end gap-2 mt-4 pt-4 border-t border-gray-50">
        ...
        <button onclick="openEditModal({{ $s }})"
            class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-gray-100 hover:bg-gray-200 text-gray-700 transition">
        ...
        <div class="relative w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <form method="POST" action="{{ route('services.store') }}" class="px-6 py-5 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" placeholder="Brief description of the service…"
                              class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300 transition resize-none"></textarea>
                </div>
